...
/** 使用する ArcGIS API for JavaScript のモジュールをインポート Start */
...
/** 使用する ArcGIS API for JavaScript のモジュールをインポート End */
...
export default class Widget extends React.PureComponent<AllWidgetProps<any>, any> {
    ...
    /** 到達圏内に含まれるレイヤーの取得および選択、連携の処理追加 Start */
    // 到達圏内のレイヤー取得および選択、連携の処理
    ...
    /** 到達圏内に含まれるレイヤーの取得および選択、連携の処理追加 End */
    ...
    /** レイヤー情報の取得処理および移動条件情報の取得処理追加 Start */
    ...
    /** レイヤー情報の取得処理および移動条件情報の取得処理 End */

    /** UI コンポーネント用ファンクション Start */
    // マーキング対象のレイヤーを設定
